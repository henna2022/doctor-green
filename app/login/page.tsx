    ...
    <div className="phone-frame">
      ...
      <main className="flex-1 px-5 py-6">
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full py-3.5 rounded-2xl bg-g1 text-white font-bold hover:bg-g2 disabled:opacity-50 transition mb-6"
        >
          {loading ? "로그인 중..." : "로그인"}
        </button>
        ...
        <Link
          href="/signup"
          className="block w-full py-3.5 rounded-2xl border-2 border-g1 text-g1 font-bold text-center hover:bg-g5 transition"
        >
          회원가입
        </Link>
      </main>
